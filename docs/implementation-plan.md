...
| Artifacts | POST-ART.* | **SIGNED OFF** on `post-artifacts`. SHA store manifest, URL layout, `xtask pack --cache pull`; dogfood tries pull; consumer.md fat dist + ArtifactTransport |
