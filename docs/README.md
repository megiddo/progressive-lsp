...
| Productization (releases, contracts, smoke) | [productization-plan.md](productization-plan.md), [productization/agent-context.md](productization/agent-context.md), [productization/release-runbook.md](productization/release-runbook.md), [distribution-architecture.md](distribution-architecture.md) |
...
| In-tree POC editor (consumer sample) | [poc-ide/README.md](poc-ide/README.md), [architecture](poc-ide/architecture.md), [OSS pins](poc-ide/third-party.md), [agent context](poc-ide/agent-context.md) |
