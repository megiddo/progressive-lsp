...
LOG-0–LOG-6 are **signed off**. Do not reopen them. Remaining operational coverage is `log7`–`log11`. Parent of `log6` is `log5`. **Supersedes** “stack complete at `log4` / do not open `log5`.”
