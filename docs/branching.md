                                                              ...
                                                              └── host6  # mux client
                                                                    └── host7  # full flavor packs (last numbered host slice)
                                                                          └── fix-superhtml-x8664  # zig qemu faccessat
                                                                                └── host-cleanup  # require superhtml in image; not host8
```
